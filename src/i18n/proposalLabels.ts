...
export const PROPOSAL_LABELS: Record<ProposalLanguage, DocumentLabels> = {
  ...
  DE: {
    ...
    packagingStandard: 'Standardverpackung',
    packagingOcean: 'Seefrachtverpackung',
    deliveryTerms: 'Lieferbedingungen',
    paymentTerms: 'Zahlungsbedingungen',
    warranty: 'Garantie',
    additionalNotes: 'Zusätzliche Hinweise',
    vatNote: 'Alle Preise verstehen sich ohne MwSt.',
    preparedBy: 'Erstellt von',
    defaultDeliveryTerms: 'DAP — vereinbarter Bestimmungsort',
    defaultPaymentTerms: '30 Tage nach Lieferung',
    defaultWarranty: '24 Monate',
    fallbackIntroduction: 'Wir freuen uns, Ihnen unser Angebot für die genannten Kozegho-Produkte zu unterbreiten. Kozegho ist spezialisiert auf Aufbereitungs- und Dosiersysteme für die Wasseraufbereitung und industrielle Prozesse. Für weitere Informationen stehen wir Ihnen jederzeit gerne zur Verfügung.'
  },
  ES: {
